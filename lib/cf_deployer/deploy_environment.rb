...
module CfDeployer
  class DeployEnvironment
    ...
    def prepare
      ...
      build_deployment_strategy(deployment, bosh, manifest_generator, @options.release_name, release_repo)
    end

    private

    def build_deployment_strategy(deployment, bosh, manifest_generator, release_name, release_repo)
      strategy_type =
      ...
      @strategy = strategy_type.new(bosh, deployment, manifest_generator, release_name, release_repo)
    end
  end
end
